...
export default function Sidebar({ isOpen, sessions }: SidebarProps) {
  return (
    <aside
      className={`fixed top-0 left-0 w-80 h-screen glass border-r border-[var(--border)] z-[99] pt-[100px] px-5 pb-5 transition-all duration-[400ms] ease-[cubic-bezier(0.4,0,0.2,1)] overflow-y-auto ${
