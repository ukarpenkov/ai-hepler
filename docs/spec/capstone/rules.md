...
[https://www.kaggle.com/competitions/vibecoding-agents-capstone-project](https://www.kaggle.com/competitions/vibecoding-agents-capstone-project)

### 5. TOTAL PRIZES AVAILABLE
12 pieces of swag, distributed equally across 4 categories: Agents for Good, Agents for Business, Concierge Agents, Freestyle.
...
- **a.** To be eligible to enter the Competition, you must be:
    ...
    - not a person or representative of an entity under U.S. export controls or sanctions (see: [https://www.treasury.gov/resourcecenter/sanctions/Programs/Pages/Programs.aspx](https://www.treasury.gov/resourcecenter/sanctions/Programs/Pages/Programs.aspx)).
